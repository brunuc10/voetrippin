...
const TestimonialsSection = () => {
  ...
  return (
    <section id="depoimentos" className="section-padding bg-gradient-dark">
      <div className="container mx-auto max-w-4xl">
        <div ref={ref} className="text-center mb-16 animate-on-scroll">
          <p className="text-primary font-medium tracking-[0.2em] uppercase text-sm mb-3">O que dizem nossos clientes</p>
        ...
        <div className="glass-card rounded-2xl p-8 sm:p-12 text-center relative">
          ...
          <p className="text-lg sm:text-xl text-foreground/90 leading-relaxed mb-8 font-light italic">
            "{t.text}"
          </p>
          ...
          <div className="flex justify-center gap-4 mt-8">
            <button onClick={prev} className="w-10 h-10 rounded-full border border-border hover:border-primary transition-colors flex items-center justify-center">
            ...
            <button onClick={next} className="w-10 h-10 rounded-full border border-border hover:border-primary transition-colors flex items-center justify-center">
